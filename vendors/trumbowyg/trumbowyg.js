...
(function (navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        // Disable editor
        toggleDisable: function toggleDisable(disable) {
            var t = this,
                prefix = t.o.prefix;
        ...
        openModalInsert: function openModalInsert(title, fields, cmd) {
            ...
            $.each(fields, function (fieldName, field) {
                ...
                html += '<label><input type="' + (field.type || 'text') + '" name="' + n + '" value="' + (field.value || '').replace(/"/g, '&quot;') + '"' + attr + '><span class="' + prefix + 'input-infos"><span>' + (!l ? lg[fieldName] ? lg[fieldName] : fieldName : lg[l] ? lg[l] : l) + '</span></span></label>';
            });
